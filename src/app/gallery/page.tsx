  ...
  return (
    ...
    <div className={styles.container} >
      <div className={styles.gallery}>
        <Image src="/img/gallery/galleryImg12.jpeg" width='200' height='200'  className={styles.image} alt="Avatar" />
        <video src='/img/gallery/galleryVid4.mp4'  width="320" height="240" autoPlay loop muted className={`${styles.image} ${styles.video}`}></video>
         <Image src="/img/gallery/galleryImg7.jpeg" width='200' height='200' className={styles.image} alt="Avatar" />
         <Image src="/img/gallery/galleryImg9.jpeg" width='200' height='200' className={styles.image} alt="Avatar" />
         <Image src="/img/gallery/galleryImg13.jpeg" width='200' height='200' className={styles.image} alt="Avatar" />
         <Image src="/img/gallery/galleryImg3.jpeg" width='200' height='200' className={styles.image} alt="Avatar" />
         <Image src="/img/gallery/galleryImg10.jpeg" width='200' height='200' className={styles.image} alt="Avatar" />
         <video src='/img/gallery/galleryVid3.mp4'  width="320" height="240" autoPlay loop muted className={`${styles.image} ${styles.video}`}></video>
          <Image src="/img/gallery/galleryImg4.jpeg" width='200' height='200' className={styles.image} alt="Avatar" />
          <Image src="/img/gallery/galleryImg6.jpeg" width='200' height='200' className={styles.image} alt="Avatar" />
          <Image src="/img/gallery/galleryImg14.jpeg" width='200' height='200' className={styles.image} alt="Avatar" />
         <video src='/img/gallery/galleryVid1.mp4'  width="320" height="240" autoPlay loop muted className={`${styles.image} ${styles.video}`}></video>
          <Image src="/img/gallery/galleryImg11.jpeg" width='200' height='200' className={styles.image} alt="Avatar" />
          <Image src="/img/gallery/galleryImg5.jpeg" 
          width='200' height='200' className={styles.image} alt="Avatar" />
          <Image src="/img/gallery/galleryImg2.jpeg"  width='200' height='200' className={styles.image} alt="Avatar" />
